...
unsigned char nRFCMD_Init(void)
{
     ...
     * DLYBS = 0, DLYBCT = 0 */
    AT91C_BASE_SPI->SPI_MR = AT91C_SPI_MSTR | AT91C_SPI_PS_FIXED | ((1<<(16+CSN_ID))^AT91C_SPI_PCS);
    AT91F_SPI_CfgCs(AT91C_BASE_SPI, CSN_ID, AT91C_SPI_BITS_8|AT91C_SPI_NCPHA|(SCBR<<8));
