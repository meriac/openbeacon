...
xxtea_encode (void)
{
	...
	while (q-- > 0)
	{
		...
		y = g_Beacon.log.block[1];
		tmp = g_Beacon.log.block[0];
		mx_encode (0);
		g_Beacon.log.block[0] = z;

		y = g_Beacon.log.block[2];
		tmp = g_Beacon.log.block[1];
		mx_encode (1);
		g_Beacon.log.block[1] = z;

		y = g_Beacon.log.block[3];
		tmp = g_Beacon.log.block[2];
		mx_encode (2);
		g_Beacon.log.block[2] = z;

		y = g_Beacon.log.block[0];
		tmp = g_Beacon.log.block[3];
		mx_encode (3);
		g_Beacon.log.block[3] = z;
	}
}
...
xxtea_decode (void)
{
	...
	while (sum != 0)
	{
		...
		z = g_Beacon.log.block[2];
		tmp = g_Beacon.log.block[3];
		mx_decode (3);
		g_Beacon.log.block[3] = y;

		z = g_Beacon.log.block[1];
		tmp = g_Beacon.log.block[2];
		mx_decode (2);
		g_Beacon.log.block[2] = y;

		z = g_Beacon.log.block[0];
		tmp = g_Beacon.log.block[1];
		mx_decode (1);
		g_Beacon.log.block[1] = y;

		z = g_Beacon.log.block[3];
		tmp = g_Beacon.log.block[0];
		mx_decode (0);
		g_Beacon.log.block[0] = y;
