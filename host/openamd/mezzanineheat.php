...
<p>Heat map showing distribution of tracked users over the last two hours.</p>
<img id="locationmap" src="http://amd.hope.net/mezzheat.png"/><br/><br/>
<br>
    ...
    function beginrefresh() {
        document.getElementById("locationmap").src = "http://amd.hope.net/mezzheat.png?" + (fudge++);
