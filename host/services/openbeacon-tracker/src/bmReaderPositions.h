...
static const TReaderItem g_ReaderList[] = {
  // BruCON  2011: group 4
  // Lounge Level 1
  {  101, 1, 1,    4, 123, 123}, //01
  {  102, 1, 1,    4, 123, 123}, //02
  {  103, 1, 1,    4, 123, 123}, //03
  {  104, 1, 1,    4, 123, 123}, //04
  {  107, 1, 1,    4, 123, 123}, //05
  {  108, 1, 1,    4, 123, 123}, //06
  {  110, 1, 1,    4, 123, 123}, //07
  {  111, 1, 1,    4, 123, 123}, //08

  // BruCON  2011: group 4
  // Hallway Level 3
  {  112, 1, 2,    4, 123, 123}, //09
  {  113, 1, 2,    4, 123, 123}, //10
  {  115, 1, 2,    4, 123, 123}, //11
  {  116, 1, 2,    4, 123, 123}, //12

  // BruCON  2011: group 4
  // Hallway VUB Aula
  {  140, 1, 3,    4, 123, 123}, //13
  {  164, 1, 3,    4, 123, 123}, //14
  {  165, 1, 3,    4, 123, 123}, //15
  {  166, 1, 3,    4, 123, 123}, //16

  // BruCON  2011: group 4
  // Hallway Worksshop A
  {  169, 1, 4,    4, 123, 123}, //17
  {  196, 1, 4,    4, 123, 123}, //18

  // BruCON  2011: group 4
  // Hallway Worksshop A
  {  197, 1, 4,    4, 123, 123}, //19
  {  100, 1, 4,    4, 123, 123}, //20
