...
static const TReaderItem g_ReaderList[] = {
  // BruCON  2011: group 4
  // Lounge Level 1
  {  101, 1, 1,    4, 123, 123}, // 193.191.70.191 X
  {  102, 1, 1,    4, 123, 123}, // 193.191.70.192 X
  {  103, 1, 1,    4, 123, 123}, // 193.191.70.193 X
  {  104, 1, 1,    4, 123, 123}, // 193.191.70.194 X
  {  107, 1, 1,    4, 123, 123}, // 193.191.70.195 X
  {  108, 1, 1,    4, 123, 123}, // 193.191.70.196 X
  {  110, 1, 1,    4, 123, 123}, // 193.191.70.197 X
  {  111, 1, 1,    4, 123, 123}, // 193.191.70.198 X

  // BruCON  2011: group 4
  // Hallway Level 3
  {  112, 2, 2,    4, 123, 123}, // 193.191.70.199 X
  {  113, 2, 2,    4, 123, 123}, // 193.191.70.200 X
  {  115, 2, 2,    4, 123, 123}, // 193.191.70.201 X
  {  116, 2, 2,    4, 123, 123}, // 193.191.70.202 X

  // BruCON  2011: group 4
  // Hallway VUB Aula
  {  140, 3, 2,    4, 123, 123}, // 193.191.70.203 X
  {  164, 3, 2,    4, 123, 123}, // 193.191.70.204 X
  {  165, 3, 2,    4, 123, 123}, // 193.191.70.205 X
  {  166, 3, 2,    4, 123, 123}, // 193.191.70.206 X

  // BruCON  2011: group 4
  // Hallway Worksshop A
  {  169, 4, 2,    4, 123, 123}, // 193.191.70.207 X
  {  196, 4, 2,    4, 123, 123}, // 193.191.70.208 X

  // BruCON  2011: group 4
  // Hallway Worksshop A
  {  197, 5, 2,    4, 123, 123}, // 193.191.70.209 X
  {  100, 5, 2,    4, 123, 123}, // 193.191.70.210 X

  // BruCON  2011: group 4
  // Crew Area
  {   11, 6, 0,    4, 123, 123}, // 193.191.70.211
  {   12, 6, 0,    4, 123, 123}, // 193.191.70.212
  {   13, 6, 0,    4, 123, 123}, // 193.191.70.213
